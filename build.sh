...
SOURCE_FILES="src/head.js src/util.js src/iterator.js src/scope.js src/chain.js src/node.js src/create.js src/pubsub.js src/promise.js src/emitter.js src/forward.js"
